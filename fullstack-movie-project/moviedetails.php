...
//	$review_result_row = $review_result->fetch_assoc();
	...
	$page_title = "E-Book Details " . $result_row['movie_name'];
	...
	<ul class="breadcrumb">
		...
		<li><a href="movies.php">Book</a></li>
		...
		<div class="col-xs-8">
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<h3>Book Rating: <?php echo $result_row['movie_rating'] ?></h3>
			...
			<?php if (empty($login)) { ?>
					<p class="lead"><a href="loginform.php">Sign in</a> or <a href="registration.php">register</a> to leave a review or make this a favorite Book!</p>
			<?php	} else { ?>
				<p>
					...
					<?php if ($role == 1) : ?>
						<a class="btn btn-danger" href="deletemovie.php?id=<?php echo $result_row['movie_id']; ?>">DELETE BOOK <i class="fa fa-close"></i></a>
				<?php
				endif;?>
			<?php } ?>
		</div>
